...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CVESERVICESERVICER']._serialized_end=364
  _globals['_CVECOLLECTORSERVICER']._serialized_start=366
  _globals['_CVECOLLECTORSERVICER']._serialized_end=460
